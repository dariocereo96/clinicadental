...
<head>
    ...
    <title>CLINICA | REGISTRAR HISTORIA</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content container">
                <form method="post" action="../../controlador/HistoriaController.php?action=registrar">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-6">
                                <label for="fechaAtencion" class="text-primary">FECHA:</label>
                                <input type="date" class="form-control" max="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d'); ?>" name="fechaAtencion" id="fechaAtencion" required>
                            </div>
                            ...
                            <div class="form-group col-6">
                                ...
                                <textarea class="form-control" name="diagnostico" id="diagnostico" rows="4" required></textarea>
                            </div>

                            <div class="form-group col-6">
                                <label for="procedimiento" class="text-primary">Procedimiento:</label>
                                <textarea class="form-control" name="procedimiento" id="procedimiento" rows="4" required></textarea>
                            </div>
                        </div>
                    </div>
