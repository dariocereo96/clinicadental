...
<head>
    ...
    <title>CLINICA | REGISTRAR DOCTOR </title>
            ...
            <div class="content container">
                <div class="card">
                    <div class="card-header bg-primary">
                        <h1 class="card-title"><i class="fas fa-id-card mr-2"></i>REGISTRAR DOCTOR</h1>
                    </div>
                    <div class="card-body">
                        <form method="post" action="../../controlador/DoctorController.php?action=registrar">
                            <div class="row">
                                ...
                                <div class="form-group col-4">
                                    <label for="cedula" class="text-primary">N° DE DOCUMENTO:</label>
                                    <input type="text" id="cedula" name="cedula" class="form-control" oninput="validarDocumento(event)" required>
                                </div>
                                <div class="form-group col-4">
                                    <label for="primerNombre" class="text-primary">Primer Nombre:</label>
                                    <input type="text" id="primerNombre" name="primerNombre" class="form-control" oninput="validarLetras(event)" required>
                                </div>
                                <div class="form-group col-4">
                                    <label for="segundoNombre" class="text-primary">Segundo Nombre:</label>
                                    <input type="text" id="segundoNombre" name="segundoNombre" class="form-control" oninput="validarLetras(event)" required>
                                </div>
                                <div class="form-group col-4">
                                    <label for="apellidoPaterno" class="text-primary">Apellido Paterno:</label>
                                    <input type="text" id="apellidoPaterno" name="apellidoPaterno" class="form-control" oninput="validarLetras(event)" required>
                                </div>
                                <div class="form-group col-4">
                                    <label for="apellidoMaterno" class="text-primary">Apellido Materno:</label>
                                    <input type="text" id="apellidoMaterno" name="apellidoMaterno" class="form-control" oninput="validarLetras(event)" required>
                                </div>
                                <div class="form-group col-4">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="date" max="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d'); ?>" id="fechaNacimiento" name="fechaNacimiento" class="form-control" required>
                                </div>
                                <div class="form-group col-4">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="tel" id="telefono" name="telefono" oninput="validarNumeros(event)" class="form-control">
                                </div>
                                <div class="form-group col-4">
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <a href="../admin/listarDoctores.php" class="btn btn-danger"><i class="fas fa-arrow-left mr-2"></i>CANCELAR</a>
                            </div>
                        </form>
                    </div>
                </div>
