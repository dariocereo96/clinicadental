            ...
            <div class="content container">
                <div class="card">
                    <div class="card-header bg-primary">
                        <h1 class="card-title"><i class="fas fa-id-card mr-2"></i>REGISTRAR USUARIO</h1>
                    </div>
                    <div class="card-body">
                        <form method="post" action="../../controlador/UsuarioController.php?action=registrar">
                            <div class="row">
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary mr-2"><i class="fas fa-id-card mr-2"></i>REGISTRAR</button>
                                <a href="../admin/listarUsuarios.php" class="btn btn-danger"><i class="fas fa-arrow-left mr-2"></i>CANCELAR</a>
                            </div>
                        </form>
                    </div>
                </div>
