...
<body class="layout-top-nav" style="height: auto;">
    <div class="wrapper">
        ...
        $especialidades = $especialidad->consultarEspecialidades();
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-primary">ESPECIALIDADES</h1>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="content container">
                <div class="card">
                    <div class="card-header">
                        <a href="registrarEspecialidad.php" class="btn btn-primary">
                            <i class="fas fa-user-plus"></i> REGISTRAR
                        </a>
                    </div>
                    <div class="card-body">
                        <table class="table table-striped mt-3" id="tablaEspecialidades">
                            <thead class="bg-primary">
                                <tr>
                                    <th>Nombre</th>
                                    <th style="max-width: 600px;">Descripcion</th>
                                    <th>Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($especialidades as $especialidad) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editarEspecialidad.php?id=<?php echo $especialidad['id'] ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Editar">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="../../controlador/EspecialidadController.php?action=eliminar&id=<?php echo $especialidad['id'] ?>" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Eliminar" onclick="return confirm('¿Estás seguro de que deseas eliminar este paciente?')">
        ...
        <script>
            const dataTableOptions = {
                ...
                language: {
                    ...
                    zeroRecords: "NINGUNA ESPECIALIDAD ENCONTRADA",
                    info: "MOSTRANDO DE _START_ A _END_ DE UN TOTAL _TOTAL_ REGISTROS",
                    infoEmpty: "NINGUNA ESPECIALIDAD ENCONTRADA",
            ...
            $(document).ready(function() {
                $('#tablaEspecialidades').DataTable(dataTableOptions);
            });
        </script>
</body>
