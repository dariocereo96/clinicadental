...
<head>
    ...
    <title>CLINICA | REGISTRAR PACIENTE</title>
            ...
            <div class="content container">
                <div class="card">
                    <div class="card-header bg-primary">
                        <h1 class="card-title"><i class="fas fa-id-card mr-2"></i>REGISTRAR PACIENTE</h1>
                    </div>
                    <div class="card-body">
                        <form method="post" action="../../controlador/PacienteController.php?action=registrar">
                            <div class="row">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="date" id="fechaNacimiento" max="<?php echo date('Y-m-d'); ?>" value="<?php echo date('Y-m-d'); ?>" name="fechaNacimiento" class="form-control" required>
                                </div>
                                <div class="form-group col-4">
