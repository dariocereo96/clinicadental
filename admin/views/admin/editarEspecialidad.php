...
<head>
    ...
    <title>CLINICA | EDITAR ESPECIALIDAD</title>
...
<body class="layout-top-nav" style="height: auto;">
    <div class="wrapper">
        ...
        $especialidad = $especialidadDAO->buscarEspecialidadId($_GET["id"]);
            ...
            <div class="content container">
                <div class="card">
                    <div class="card-header bg-primary">
                        <h3 class="card-title"><i class="fas fa-pencil-alt mr-2"></i>EDITAR ESPECIALIDAD</h3>
                    </div>
                    <div class="card-body">
                        <form method="post" action="../../controlador/EspecialidadController.php?action=editar">
                            <div class="row">
                                <input type="hidden" name="id" value="<?php echo $especialidad['id']; ?>">
                                <div class="form-group col-12">
                                    <label for="nombre">Nombre del Tratamiento:</label>
                                    <input type="text" name="nombre" value="<?php echo $especialidad['nombre'] ?>" id="nombre" class="form-control" required>
                                </div>
                                <div class="form-group col-12">
                                    <label for="descripcion-12">Descripción:</label>
                                    <textarea name="descripcion" id="descripcion" class="form-control" style="height: 120px;" required><?php echo $especialidad['descripcion'] ?></textarea>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary mr-2"><i class="fas fa-save mr-2"></i>REGISTRAR</button>
                                <a href="listarEspecialidades.php" class="btn btn-danger"><i class="fas fa-arrow-left mr-2"></i>CANCELAR</a>
                            </div>
                        </form>
                    </div>
                </div>
