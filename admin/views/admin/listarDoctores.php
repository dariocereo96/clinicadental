...
<body class="layout-top-nav" style="height: auto;">
    <div class="wrapper">
        ...
        $doctores = $doctor->consultarDoctores();
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-primary">DOCTORES</h1>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="content container">
                <div class="card">
                    <div class="card-header">
                        <a href="registrarDoctor.php" class="btn btn-primary">
                            <i class="fas fa-user-plus"></i> REGISTRAR
                        </a>
                    </div>
                    <div class="card-body">
                        <table class="table table-striped mt-3" id="tablaDoctores">
                            ...
                            <tbody>
                                <?php foreach ($doctores as $doctor) : ?>
                                    <tr>
                                        <td><?= $doctor['cedula'] ?></td>
                                        <td><?= $doctor['apellidoPaterno'] . " " . $doctor['apellidoMaterno'] ?></td>
                                        <td><?= $doctor['primerNombre'] . " " . $doctor['segundoNombre'] ?></td>
                                        <td><?= $doctor['especialidad'] ?></td>
                                        <td><?= $doctor['telefono'] ?></td>
                                        <td><?= $doctor['username'] ?></td>
                                        <td>
                                            <a href="editarDoctor.php?id=<?php echo $doctor['id'] ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Editar">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="../../controlador/DoctorController.php?action=eliminar&id=<?php echo $doctor['id'] ?>" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Eliminar" onclick="return confirm('¿Estás seguro de que deseas eliminar este paciente?')">
        ...
        <script>
            const dataTableOptions = {
                language: {
                    ...
                    zeroRecords: "NINGUN DOCTOR ENCONTRADO",
                    info: "MOSTRANDO DE _START_ A _END_ DE UN TOTAL _TOTAL_ REGISTROS",
                    infoEmpty: "NINGUN DOCTOR ENCONTRADO",
            ...
            $(document).ready(function() {
                $('#tablaDoctores').DataTable(dataTableOptions);
            });
        </script>
</body>
